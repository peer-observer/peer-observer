...
pub struct Metrics {
    ...
    pub log_compact_block_reconstruction_txs_requested: IntGauge,
    pub log_compact_block_reconstruction_txs_extra_pool: IntGauge,
}
...
impl Metrics {
    ...
    pub fn new() -> Self {
        ...
        ig!(log_compact_block_reconstruction_txs_requested, "The number of transactions requested for compact block reconstruction.", registry);
        ig!(log_compact_block_reconstruction_txs_extra_pool, "The number of transactions requested for compact block reconstruction that were found in the extra transaction pool.", registry);
